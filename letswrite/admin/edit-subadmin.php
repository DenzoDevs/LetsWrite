...
$email=$_POST['emailid'];
$query=mysqli_query($con,"Update  users set EmailId='$email'  where userType=Sadmin && id='$aid'");
if($query)
{
...
<html lang="en">
    <head>
        ...
        <title>Lets Write |Edit Subadmin</title>
...
<?php 
$aid=intval($_GET['said']);
$query=mysqli_query($con,"Select * from  users where userType=Sadmin && id='$aid'");
$cnt=1;
...
?>
                        		...
                        		<form class="form-horizontal" name="suadmin" method="post">
	                                   ...
	                                   <div class="col-md-10">
	                                       <input type="text" class="form-control" value="<?php echo htmlentities($row['UserName']);?>" name="adminusernmae" readonly>
	                                                </div>
	                                            </div>
