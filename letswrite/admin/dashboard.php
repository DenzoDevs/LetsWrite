...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Lets Write| Dashboard</title>
        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <a href="index.html" class="logo"><span>Lets Write<span>Admin</span></span><i class="mdi mdi-layers"></i></a>
                    <!-- Image logo -->
...
?>
   ...
   <div class="row">
      ...
      <a href="trash-articles.php"> <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    <i class="mdi mdi-layers widget-one-icon"></i>
                                    <div class="wigdet-one-content">
