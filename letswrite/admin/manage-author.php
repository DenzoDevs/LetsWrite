...
{
	$id=intval($_GET['rid']);
	$query=mysqli_query($con,"delete from  users  where id='$id' && userType=Author");
echo "<script>alert('Author details deleted.');</script>";
echo "<script type='text/javascript'> document.location = 'manage-author.php'; </script>";
}
...
<button id="addToTable" class="btn btn-success waves-effect waves-light">Add <i class="mdi mdi-plus-circle-outline" ></i></button>
												...
												<div class="table-responsive">
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select * from  users where userType='Author'");
$cnt=1;
...
<td><a href="edit-author.php?said=<?php echo htmlentities($row['id']);?>"><i class="fa fa-pencil" style="color: #29b6f6;"></i></a> 
	&nbsp;<a href="manage-author.php?rid=<?php echo htmlentities($row['id']);?>&&action=del"> <i class="fa fa-trash-o" style="color: #f05050"></i></a> </td>
</tr>
<?php
$cnt++;
 } ?>
