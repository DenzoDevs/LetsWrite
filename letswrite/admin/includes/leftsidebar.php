...
<?php endif;?>
  ...
  <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                <?php if($_SESSION['utype']=='Author'):?>
                                    <li><a href="add-article.php">Add Articles</a></li>
                                <?php endif;?>
                                    <li><a href="manage-articles.php">Manage Articles</a></li>
                                     <li><a href="trash-articles.php">Trash Articles</a></li>
                                </ul>
                            </li>  
   <li class="has_sub">
                    ...
                    <div class="help-box">
                        ...
                        <p class=""><span class="text-custom">Email:</span> <br/> denzodevs@gmail.com</p>
                    </div>
