...
$password=md5($_POST['newpassword']);
        $query=mysqli_query($con,"select id from users where  EmailId='$email' and UserName='$username' ");
        
    $ret=mysqli_num_rows($query);
    if($ret>0){
      $query1=mysqli_query($con,"update users set Password='$password'  where  EmailId='$email' && UserName='$username' ");
       if($query1)
   {
...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Lets Write| Forgot Password</title>
