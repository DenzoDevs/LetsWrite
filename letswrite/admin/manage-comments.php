											...
											<div class="demo-box m-t-20">
												...
												<div class="table-responsive">
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select comments.id,  comments.name,comments.email,comments.postingDate,comments.comment,articles.id as postid,articles.PostTitle from  comments join articles on articles.id=comments.postId where comments.status=1");
$cnt=1;
...
<td><a href="edit-article.php?pid=<?php echo htmlentities($row['postid']);?>"><?php echo htmlentities($row['PostTitle']);?></a> </td>
