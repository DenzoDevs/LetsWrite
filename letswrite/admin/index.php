...
$sql =mysqli_query($con,"SELECT UserName,EmailId,Password,userType FROM users WHERE (UserName='$uname' && Password='$password')");
...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Lets Write.">
        <meta name="author" content="Denzo">


        <!-- App title -->
        <title>Lets Write| Login Panel</title>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="wrapper-page">
                            ...
                            <div class="m-t-40 account-pages">
                                <div class="text-center account-text-box" >
                                    <h2 class="text-uppercase" style="text-decoration: aqua;">
                                    Login Details
                                    </h2>
                                </div>
