...
$email=$_POST['emailid'];
$query=mysqli_query($con,"Update  users set EmailId='$email'  where userType=Author && id='$aid'");
if($query)
{
echo "<script>alert('Author details updated.');</script>";
}
else{
...
<html lang="en">
    <head>
        ...
        <title>Lets Write |Edit Author</title>
...
?>
                        		...
                        		<form class="form-horizontal" name="author" method="post">
	                                   ...
	                                   <div class="col-md-10">
	                                       <input type="text" class="form-control" value="<?php echo htmlentities($row['UserName']);?>" name="adminusernmae" required>
	                                                </div>
	                                            </div>
            ...
            <div class="col-md-10">
            <input type="text" class="form-control" value="<?php echo htmlentities($row['EmailId']);?>" name="emailid" required>
           </div>
           </div>
