...
<html lang="en">
    <head>
        ...
        <title>Lets Write | Add Subadmin</title>
...
<form class="form-horizontal" name="addsuadmin" method="post">
       ...
       <label for="exampleInputusername">Username (used for login)</label>
               <input type="text" placeholder="Enter Sub-Admin Username"  name="sUserName" id="sUserName" class="form-control" pattern="^[a-zA-Z][a-zA-Z0-9-_.]{5,12}$" title="Username must be alphanumeric 6 to 12 chars" onBlur="checkAvailability()"  required>
